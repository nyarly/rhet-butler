goog.require('rhetButler.Presenter');
...
//                  expect(list.currentStep.hasClass("am-at")).toBe(true);
    ...
    if(/phantom/i.test(window.navigator.userAgent)) {
      ...
      describe('moveTo slide past animation', function(){
          ...
          beforeEach(function() {
              var transitioning;
              document.body.innerHTML = __html__["javascript/test_support/long-animation-group-1.html"] + document.body.innerHTML;
      ...
      describe('jump forward - looped animation classes', function() {
          var transitioning;
          beforeEach(function(){
              document.body.innerHTML = __html__["javascript/test_support/looped-animation-group-1.html"] + document.body.innerHTML;
      ...
      describe('jump forward - transition classes', function() {
          var transitioning;
          beforeEach(function(){
              document.body.innerHTML = __html__["javascript/test_support/long-transition-group-1.html"] + document.body.innerHTML;
